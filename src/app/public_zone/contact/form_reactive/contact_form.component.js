...
var ContactFormReactiveComponent = (function () {
    function ContactFormReactiveComponent() {
        this.langs = [
            'English',
            'French',
            'German',
    ...
    ContactFormReactiveComponent.prototype.ngOnInit = function () {
        this.createFormControls();
        this.createForm();
    };
    ContactFormReactiveComponent.prototype.createFormControls = function () {
    ...
    ContactFormReactiveComponent.prototype.createForm = function () {
    ...
    ContactFormReactiveComponent.prototype.onSubmit = function () {
        if (this.myform.valid) {
            console.log("Form Submitted!");
            this.myform.reset();
        }
    };
    return ContactFormReactiveComponent;
}());
ContactFormReactiveComponent = __decorate([
    core_1.Component({
...
exports.ContactFormReactiveComponent = ContactFormReactiveComponent;
